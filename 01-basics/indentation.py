...
cisla = [11, 128, 34, 58, 12, 958, 753, 1234, 2, 87, 9999, 62]
def numb(nasobek):
    """
    Funkce vynásobí čísla, která jsou
    větší než 1000, hodnotou zadanou v parametru
    """
    for idx, x in enumerate(cisla):
        if x < 1000:
            print(str(idx+1) + '. cislo - ' + str(x) + ' | ' + str(x) + ' * ' + str(nasobek) + ' = ' + str(x*nasobek))

# Vypíše docstring spojený s funkcí num
print(numb.__doc__)
# Vyvolá funkci num s parametrem 2
numb(2)