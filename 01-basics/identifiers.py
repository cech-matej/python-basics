...
x = 0
#global = 1 - název global je rezervovaný pro python
num_global = 1
PI = 3.14
city = "Opava"
#hilda@sspu-opava.cz = 'Hilda Dokonalá' - použití neplatných znaků (@-.)
hilda_sspu_opava_cz = 'Hilda Dokonalá'
password2 = 'TajneHeslo'
#007agent = 'James Bond' - proměnná nesmí začínat číslem
agent007 = 'James Bond'
